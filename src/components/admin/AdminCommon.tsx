...
export const TemplateButton = ({ filename, data }: { filename: string; data: unknown }) => <Button type="button" variant="ghost" onClick={() => downloadFile(filename, JSON.stringify(data, null, 2))}>Download {filename}</Button>;
