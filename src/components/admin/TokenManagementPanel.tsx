...
import { AlertBox, StatCard } from './AdminCommon';
...
export const TokenManagementPanel = ({ results, toast }: { results: AssessmentResult[]; toast: (message: string, tone?: 'teal' | 'amber' | 'rose') => void }) => {
  ...
  return <div className="space-y-6">
    <AlertBox tone="amber">Proteksi token lokal tidak setara dengan autentikasi server. Untuk produksi resmi, gunakan backend/database dan autentikasi server.</AlertBox>
